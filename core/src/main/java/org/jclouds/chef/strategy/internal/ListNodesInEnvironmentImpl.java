...
public class ListNodesInEnvironmentImpl extends BaseListNodesImpl implements ListNodesInEnvironment {
   ...
   @Override
   public Iterable<? extends Node> executeConcurrently(ExecutorService executor, String environmentName) {
      return this.executeConcurrently(MoreExecutors.listeningDecorator(executor), environmentName);
   }

   @Override
   public Iterable<? extends Node> executeConcurrently(ListeningExecutorService executor,
