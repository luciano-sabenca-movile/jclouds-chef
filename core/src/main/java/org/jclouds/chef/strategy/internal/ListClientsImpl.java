...
public class ListClientsImpl implements ListClients {
   ...
   @Override
   public Iterable<? extends Client> executeConcurrently(ExecutorService executorService) {
      return this.executeConcurrently(MoreExecutors.listeningDecorator(executorService));
   }

   @Override
   public Iterable<? extends Client> executeConcurrently(ListeningExecutorService listeningExecutor) {
