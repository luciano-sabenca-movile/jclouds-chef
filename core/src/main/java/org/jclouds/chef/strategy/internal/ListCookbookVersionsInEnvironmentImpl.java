...
public class ListCookbookVersionsInEnvironmentImpl extends BaseListCookbookVersionsImpl
   ...
   @Override
   public Iterable<? extends CookbookVersion> executeConcurrently(ExecutorService executor,
   ...
   @Override
   public Iterable<? extends CookbookVersion> executeConcurrently(ListeningExecutorService executor,
         String environmentName) {
